...
public class AddressBookDisplay extends JFrame {
    ...
    public AddressBookDisplay() {
        ...
        modifyButton.setText("Update Current Entry");
        modifyButton.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
                //when the user clicks on this button, whatever is in the text fields should be the new fields in the row
    ...
    private void updateButtonActionPerformed(ActionEvent e) {
        int result = personQueries.updatePerson(firstNameTextField.getText(),
                lastNameTextField.getText(), emailTextField.getText(),
                phoneTextField.getText(), currentEntryIndex);
        ...
        //after updaing the entry, resave the contents into results
        results = personQueries.getAllPeople();
        numberOfEntries = results.size();
    }
